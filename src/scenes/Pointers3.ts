...
export default class Pointers3 extends Phaser.Scene{
    ...
    create(){
        ...
        this.add.text(125,100,"Addresses").setFontSize(20);
        this.add.text(300,100,"Data Values").setFontSize(20);
        this.add.text(500,100,"Code:").setFontSize(20);
